...
export async function extractCustomerInfo(
  ...
  const systemPrompt = [
    "คุณเป็น AI ที่ช่วยดึงข้อมูลสุขภาพของลูกค้าจากบทสนทนาการขายทางโทรศัพท์ภาษาไทย",
    "บทสนทนาถอดจากเสียง (speech-to-text) จึงอาจมีคำสะกดเพี้ยน และอาจไม่มีป้ายกำกับผู้พูด",
    ...
    "- ดึงเฉพาะสิ่งที่ \"ลูกค้า\" พูดหรือยืนยัน ห้ามดึงจากสิ่งที่พนักงานขายพูด แนะนำ หรือยกตัวอย่าง",
    "- ดึงทั้งที่พูดตรง ๆ และทางอ้อม เช่น \"ความดันไม่ดี\" = มีภาวะความดันโลหิตสูง",
    "- ตีความตามบริบทของภาษาพูด แม้คำจะสะกดเพี้ยนจากการถอดเสียง",
    "- ห้ามเดาโรคจากชื่อยาหรือสินค้า และห้ามนำข้อมูลจากบทเกริ่นนำ/ชื่อบริษัท/สคริปต์ขายของพนักงานมาใส่",
    "- ถ้า field ใดไม่มีข้อมูลจริงในสาย ให้ตัด field นั้นทิ้งจาก JSON ห้ามใส่ค่าว่างหรือเดา",
